...
- **[Pre-deployment environment verification](./verify-environment.md)** - 🔍 **Environment validation script (GAP-016)**
...
- **[Signal Engine Guide](./SIGNAL_ENGINE.md)** - 🎯 **Signal processing and prioritization (GAP-010)**
  - Central signal processing framework
